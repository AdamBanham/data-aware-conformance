...
WRK_DIR = join(".")
LOG_ONE_FILE = join(WRK_DIR,"dac_log_one.xes")
LOG_TWO_FILE = join(WRK_DIR,"dac_log_two.xes")
LOG_THREE_FILE_A = join(WRK_DIR,"dac_log_three_alpha.xes")
LOG_THREE_FILE_B = join(WRK_DIR,"dac_log_three_beta.xes")
LOG_THREE_FILE_C = join(WRK_DIR,"dac_log_three_gamma.xes")
...
def make_log_two(log):
    ...
    clog._attributes["concept:name"] = "DAC LOG TWO"
...
def make_log_three(log):
    ...
    log_a._attributes["concept:name"] = "DAC LOG THREE - ALPHA"
    write_xes(log_a, LOG_THREE_FILE_A)
    log_a._list = deepcopy(log._list) + log_b._list
    log_a._attributes["concept:name"] = "DAC LOG THREE - BETA"
    ...
    log_a._attributes["concept:name"] = "DAC LOG THREE - GAMMA"
