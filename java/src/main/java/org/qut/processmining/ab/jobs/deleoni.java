...
public class deleoni {
	
	private static int defaultMoveOnModelCost = 2;
	private static int defaultMoveOnLogCost = 3;
	private static int defaultMissingWriteOpCost = 1;
	private static int defaultIncorrectWriteOpCost = 1;
			...
			while (run < 2) {
				...
				try {
					for(XLog log: logs) {
						...
						config.setUsePartialDataAlignments(true);
